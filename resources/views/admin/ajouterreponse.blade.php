                                ...
                                <div class="col-md-12">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body"><h5 class="card-title"></h5>
                                            <form class="">
                                                <div class="position-relative form-group col-6"><label for="exampleEmail" class="">ID</label><input name="email" id="exampleEmail" placeholder="" type="email" class="form-control"></div>
                                                <div class="position-relative form-group col-6"><label for="examplePassword" class="">Numéro de question</label><input name="password" id="examplePassword" placeholder="" type="text"
                                                                                                                                                       class="form-control"></div>
																																					    <div class="position-relative form-group col-6"><label for="examplePassword" class="">Bonne reponse</label><input name="password" id="examplePassword" placeholder="jj/mm/aaaa" type="text"
                                                                                                                                                       class="form-control"></div>
                                                                                ...
                                                                                <div class="vertical-timeline-element-content bounce-in">
                                                                                    <h4 class="timeline-title">Something not important
                                                                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                                            ...
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img
                                                                                                    src="{{asset('backend/assets/images/avatars/2.jpg')}}"
                                                                                                        alt=""></div>
                                                                                            </div>
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img
                                                                                            ...
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img
                                                                                                    src="{{asset('backend/assets/images/avatars/4.jpg')}}"
                                                                                                        alt=""></div>
                                                                                            </div>
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img
                                                                                                    src="{{asset('backend/assets/images/avatars/5.jpg')}}"
                                                                                                        alt=""></div>
                                                                                            </div>
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img
                                                                                                    src="{{asset('backend/assets/images/avatars/9.jpg')}}"
                                                                                                        alt=""></div>
                                                                                            </div>
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img
                                                                                                    src="{{asset('backend/assets/images/avatars/7.jpg')}}"
                                                                                                        alt=""></div>
                                                                                            </div>
                                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                                <div class="avatar-icon"><img
                                                                                                    src="{{asset('backend/assets/images/avatars/8.jpg')}}"
                                                                                                        alt=""></div>
                                                                                            </div>
                                ...
                                <div class="vertical-timeline-element-content bounce-in">
                                    <h4 class="timeline-title">Something not important
                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                            ...
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                    src="{{asset('backend/assets/images/avatars/6.jpg')}}"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
